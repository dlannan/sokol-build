...
call cl.exe /Ilib/cgltf %BASE_INCLUDE% %DEFS% /Fe:bin\cgltf_dll.dll lib\cgltf-dll.c %LINK_FLAGS%

call cl.exe /Ilib/duktape %BASE_INCLUDE% %DEFS% /Fe:bin\duktape_dll.dll lib\duktape-dll.c %LINK_FLAGS%
